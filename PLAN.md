...
## App Description
A reactive, real-time todo application built with Electric SQL that syncs tasks instantly across clients. Users can create, complete, prioritize, and manage todos with due dates in a clean single-list interface.
